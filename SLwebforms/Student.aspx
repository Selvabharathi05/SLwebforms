<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="SLwebforms.Student" %>
...
<body style="text-align:Center;background-color:azure">
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            Enter Student Id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :<asp:TextBox ID="TextBox1" runat="server" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
            <br />
            <br />
