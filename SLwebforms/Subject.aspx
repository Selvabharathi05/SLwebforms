<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Subject.aspx.cs" Inherits="SLwebforms.Subject" %>
...
<body style="text-align:Center;background-color:greenyellow">
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            Enter Subject Id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :<asp:TextBox ID="TextBox1" runat="server" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
            <br />
            <br />
